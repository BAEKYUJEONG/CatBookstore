...
class UserBook: Object {
    ...
    convenience init(bookTitle: String, author: String, publisher: String, image: String, pubDate: String, descriptionBook: String, customerReviewRank: Float, priceStandard: Int, link: String) {
